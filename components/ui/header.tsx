        ...
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          <nav className="hidden md:flex md:grow">
            ...
            {/* <ul className="flex grow justify-end flex-wrap items-center">
              <li>
                <Link href="/reference" className="font-medium text-gray-600 hover:text-gray-900 px-5 py-3 flex items-center transition duration-150 ease-in-out">Demo</Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/yourbot" className="font-medium text-gray-600 hover:text-gray-900 px-5 py-3 flex items-center transition duration-150 ease-in-out">Your bot</Link>
              </li>
            </ul> */}
            ...
            <ul className="flex grow justify-end flex-wrap items-center">
              ...
              <li>
                <Link href="/app/login" className='consoleButtonContian'>
                    <button className='consoleButton'>
                      <span>Enter your console</span>
                    </button>                  
                  {/* <span>Sign in your console</span>
                  <svg className="w-3 h-3 fill-current text-gray-400 shrink-0 ml-2 -mr-1" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
                    <path d="M11.707 5.293L7 .586 5.586 2l3 3H0v2h8.586l-3 3L7 11.414l4.707-4.707a1 1 0 000-1.414z" fillRule="nonzero" />
                  </svg> */}
                </Link>
